...
@ApiModel("档案采购信息输出")
public class AssArchivePurchaseInfoVo {
	...
	public String getPurchaseModeStr() {
		return purchaseModeStr;
	}
	public void setPurchaseModeStr(String purchaseModeStr) {
		this.purchaseModeStr = purchaseModeStr;
	}
	public String getTenderFormStr() {
		return tenderFormStr;
	}
	public void setTenderFormStr(String tenderFormStr) {
		this.tenderFormStr = tenderFormStr;
	}
