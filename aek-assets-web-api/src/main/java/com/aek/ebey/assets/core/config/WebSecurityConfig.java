...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception
    {
        httpSecurity
                ...
                .permitAll()
                .antMatchers("/assets/pmAssets/exportAssert")
                .permitAll()
                .antMatchers("/assets/pmAssets/getQRCode/*")
                .permitAll()
                .antMatchers("/assets/assetsInfo/getTemplate")
                .permitAll()
                .antMatchers("/assets/restAPI/updateAssetsRepairStatusByIdNoToken/*/*")
                .permitAll()
                .antMatchers("/static/**")
                .permitAll()
                .anyRequest()
