package com.aek.ebey.assets.mybatis;
...
public class Generator {
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:mysql://192.168.1.135:3306/assets_feat?characterEncoding=utf8");
		mpg.setDataSource(dsc);
		// 策略配置
		StrategyConfig strategy = new StrategyConfig();
//		strategy.setTablePrefix("sys_");// 此处可以修改为您的表前缀
		strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
		// strategy.setInclude(new String[] { "user" }); // 需要生成的表,ass_discard
		strategy.setInclude(new String[] { "ass_archive_purchase_info_attachment","ass_archive_purchase_info_fund_sources"}); // 需要生成的表
